...
public class Common {
//    public static final String baseUrl = "https:/hapdel.in/api/v1/";
    public static final String baseUrl = "http://192.168.0.143/hapdel/api/v1/";
    private static final String TAG = "Common";
    public static boolean service_available = false;
    public static String currentCity = "";
    public static String currentLat = "28.4595";

...
public class OrderDetailActivity extends AppCompatActivity {
    ...
    private com.utility.hapdelvendor.Model.UserOrderModel.OrderModel.Datum parentOrder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentOrder = new Gson().fromJson(getIntent().getStringExtra("order"), com.utility.hapdelvendor.Model.UserOrderModel.OrderModel.Datum.class);

        shimmerRecycler = (ShimmerRecyclerView) findViewById(R.id.shimmer_recycler_view);

        items_view = findViewById(R.id.items_view);
        orderedItemsAdapter = new OrderedItemsAdapter(this, new ArrayList<Datum>());
    ...
    public void fetchOrderDetails() {
        ...
        Call<OrderDetailModel> orderDetailModelCall = getApiInstance().fetchVendorOrderDetails(getCurrentUser().getId(), getCurrentUser().getAccessToken(), "1", parentOrder.getId());
                ...
                if (response.body() != null) {
                    ...
                    if (orderDetailModel.getResult().equals("success")) { //very important conditon
                        if (orderDetailModel.getData() != null && orderDetailModel.getData().size() > 0) {
                            ...
                            Log.d(TAG, "onResponse: type "+datum.getType());
